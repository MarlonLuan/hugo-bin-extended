...
/**
 ...
 @param {import('package-config').Config} config Resolved `hugo-bin-extended` package config.
...
/**
 ...
 @param {string} cwd Directory to read `hugo-bin-extended` config from.
